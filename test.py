...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--setup-uv", default=False, action="store_true", help="Setup UV environment for the addon"
    )
    args = parser.parse_args()
    test_addon(args.addon, enable_watch=not args.disable_watch, setup_uv=args.setup_uv)
